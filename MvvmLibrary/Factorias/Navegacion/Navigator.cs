...
namespace MvvmLibrary.Factorias.Navegacion
{
    public class Navigator : INavigator
    {
        ...
        {
            Xamarin.Forms.Page vista = await Navigation.PopAsync();
        ...
        public async Task<TViewModel> PushAsync<TViewModel>(Action<TViewModel> action = null)
        ...
        public async Task<TViewModel> PushModalAsync<TViewModel>(Action<TViewModel> action = null)
            where TViewModel : class, IViewModel
        {
            TViewModel viewModel;
            var vista = _viewFactory.Resolve<TViewModel>(out viewModel, action);
